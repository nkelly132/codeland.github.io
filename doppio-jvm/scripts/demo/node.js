...
(function() {
  "use strict";
  var CacheSource, CompositedFileSource, DoppioFile, FSState, FileIndex, FileSource, GetIEByteArray_ByteStr, LocalStorageSource, Stat, WebserverSource, basename, canUsePostMessage, config, fs_state, handleMessage, inject_vbscript, messageName, root, setZeroTimeout, timeouts, win, _,
  ...
  config = window.nodeconfig != null ? window.nodeconfig : window.nodeconfig = {};
  ...
  if (config.listing_file == null) {
    config.listing_file = '/browser/listings.json';
  }

  if (config.storage_prefix == null) {
